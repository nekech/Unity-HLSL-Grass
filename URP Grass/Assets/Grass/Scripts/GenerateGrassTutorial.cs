...
public class GenerateGrassTutorial : MonoBehaviour
{
    ...
    void Update()
    {
        Material.SetMatrix("_LocalToWorld", AttachObject.transform.localToWorldMatrix); //TODO add to article
        Material.SetMatrix("_WorldToLocal", AttachObject.transform.worldToLocalMatrix); //TODO add to article
